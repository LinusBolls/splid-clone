...
import {fetchCurrencies, fetchHistoricalRates} from "./ExchangeRatesApiClient";
...
export class CurrenciesService {
    constructor(private currencyMapper: CurrencyMapper, private currencyRateMapper: CurrencyRateMapper) {
    }
    ...
    async convert(symbolBase: string, symbolQuote: string, amount: number, date: Date) {
        await this.populateTables(date)
